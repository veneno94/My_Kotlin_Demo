                ...
                if (mPage <= 5) { //5页后没有数据
                    for (i in 0..19) {
                        when{
                            ...
                            i % 5 == 1 -> data.add("如果有来世，我一定要和你再续前缘，我要一直爱着你 护着你 想着你")
                            i % 5 == 2 -> data.add("如果有来世，我一定要和你再续前缘，我要一直爱着你 抱着你 护着你 佛说：五百年的回眸，才换来今生的一次擦肩而过")
                            i % 5 == 3 -> data.add("如果有来世，我一定要和你再续前缘，我要一直爱着你 抱着你 护着你 佛说：五百年的回眸，才换来今生的一次擦肩而过，我要在三生石上刻上我们的名字，来世我要找到你")
                            i % 5 == 4 -> data.add("如果有来世，我一定要和你再续前缘，我要一直爱着你 抱着你 护着你 佛说：五百年的回眸，才换来今生的一次擦肩而过，我要在三生石上刻上我们的名字，来世我要找到你")
